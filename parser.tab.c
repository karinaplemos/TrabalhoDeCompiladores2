...
{
       0,    86,    86,    95,   102,   110,   125,   134,   142,   150,
     161,   171,   178,   185,   193,   204,   214,   221,   228,   236,
     243,   250,   257,   265,   281,   287,   295,   306,   320,   327,
     335,   346,   353,   361,   368,   376,   387,   395,   404,   413,
     420,   427,   434,   441,   448,   456,   465,   474,   482,   491,
     500,   508,   517,   525,   533,   542,   548,   555
};
#endif
...
static const yytype_int8 yytable[] =
{
      ...
      72,    73,    74,    11,    25,    26,    10,    76,    27,    15,
      28,    16,    19,     7,    29,    30,    31,    32,    18,     7,
      25,    26,    68,    69,    14,    19,    28,    83,    84,    14,
      29,    30,    31,    50,    70,    71,    81,    82,    90,    25,
...
#line 295 "parser.y"
                                                            {(yyval.tkn1).no_ = criaNo("WhileStmt");
                                                             ...
                                                             filhos[1] = (yyvsp[0].tkn1).no_; 
                                                             filhos[2] = criaArvoreIfGoto("GotoTagX", (yyvsp[-2].tkn1).no_);
                                                             addFilhos((yyval.tkn1).no_,filhos,3);
                                                             free(filhos);
                                                            }
...
void identificador_nao_declarado(char *identificador, int linha){    
    ...
    {
        fprintf(arquivo, "Linha: Identicador %s nao declarado anteriormente\n", linha, identificador);
    }
}
